            ...
            <div className="">
                <div className="container mx-auto flex flex-col items-center py-12 sm:py-24">
                    <div className="w-11/12 sm:w-2/3 mb-5 sm:mb-10">
                        ...
                        <p className="mt-5 sm:mt-10 text-gray-600 font-normal text-center text-lg sm:text-lg">Flexible Social Media Marketing Solutions to keep you ahead of competition.<br/>Digital Transformation Strategy that takes your business to the next </p>
                    </div>
