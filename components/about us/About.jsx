        ...
        <>
            <div className="w-full flex md:flex-col flex-col-reverse items-center justify-center  py-12">
                ...
                <div className="md:absolute flex flex-col items-center justify-center px-4">
                    ...
                    <div>
                        <button role="button" aria-label="view all" className="text-base font-medium leading-4 py-4 px-7 text-white bg-orange-700 rounded mt-12 hover:bg-indigo-600 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700">
                            <Link href={'/services'}>
